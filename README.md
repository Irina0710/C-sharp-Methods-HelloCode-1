## Почувствуй себя интерном*
 ...
 9. [Показать последнюю цифру трёхзначного числа](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW09)
10. [Показать вторую цифру трёхзначного числа](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW10)
11. [Дано число из отрезка [10, 99]. Показать наибольшую цифру числа](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW11)
12. [Удалить вторую цифру трёхзначного числа](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW12)
13. [Выяснить, кратно ли число заданному, если нет, вывести остаток.](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW13)
14. [Найти третью цифру числа или сообщить, что её нет](https://github.com/Irina0710/C-sharp-Methods-HelloCode-1/tree/main/HW14)
